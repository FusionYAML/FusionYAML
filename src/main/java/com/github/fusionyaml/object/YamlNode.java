 ...
 *
 * @deprecated Use {@link YamlObject} instead of this class. This object does
 *             not have any functionality in most {@link Configuration}s and
 *             causes issues with efficiency. {@link YamlObject} can represent
 *             a Yaml node.
 */
@Deprecated
...
//    private static final ObjectSerializer serializer = new ObjectSerializer();
    ...
    public YamlNode addChild(@NotNull List<String> path, Object value) {
        ...
        YamlElement element = YamlUtils.toElement(value);
